    ...
    <div id="accordion-art">
      ...
      <div class="card">
        ...
        <div id="collapse-exo-art-02" class="collapse" data-toggle="collapse" data-parent="#accordion-art">
          <div class="card-body">
            <img src="exos/exo-art-02.php" alt="image aléatoire" class="img-fluid">
          </div>
        </div>
      </div>
      <div class="card">
        ...
        <div id="collapse-exo-art-03" class="collapse" data-toggle="collapse" data-parent="#accordion-art">
          <div class="card-body">
            <img src="exos/exo-art-03.php" alt="image aléatoire" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="accordion-divers">
      ...
      <div class="card">
        ...
        <div id="collapse-exo-divers-01" class="collapse" data-toggle="collapse" data-parent="#accordion-divers">
          <div class="card-body">
            <?php function reverse($string) { $reverse = strrev($string); return $reverse;} echo reverse("Hello");
            ?>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div id="collapse-exo-divers-02" class="collapse" data-toggle="collapse" data-parent="#accordion-divers">
          <div class="card-body">
          <?php require("exos/exo-random.php"); ?>
          </div>
        </div>
      </div>
